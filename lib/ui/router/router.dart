...
@MaterialAutoRouter(
  routes: <AutoRoute>[
    ...
    CustomRoute(page: UsageSummaryScreen, transitionsBuilder: TransitionsBuilders.fadeIn),
    CustomRoute(page: SearchScreen, transitionsBuilder: TransitionsBuilders.fadeIn),
