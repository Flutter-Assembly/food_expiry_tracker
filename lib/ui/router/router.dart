...
@MaterialAutoRouter(
  routes: <AutoRoute>[
    ...
    CustomRoute( 
      ...
      children: <AutoRoute>[ 
        CustomRoute(page: HomeScreen, transitionsBuilder: TransitionsBuilders.fadeIn, initial: true),
        CustomRoute(page: StorageDetailScreen, transitionsBuilder: TransitionsBuilders.slideLeft),         
        CustomRoute(page: FoodDetailScreen, transitionsBuilder: TransitionsBuilders.slideLeft),
      ],
    ), 
    CustomRoute(page: AddFoodScreen, transitionsBuilder: TransitionsBuilders.fadeIn),
    CustomRoute(page: FavoriteScreen, transitionsBuilder: TransitionsBuilders.fadeIn),
    CustomRoute(page: ProfileSettingScreen, transitionsBuilder: TransitionsBuilders.fadeIn),
    CustomRoute(page: StorageSummaryScreen, transitionsBuilder: TransitionsBuilders.fadeIn),
    CustomRoute(page: SearchScreen, transitionsBuilder: TransitionsBuilders.slideBottom),
    ...
    CustomRoute(page: FeedbackScreen, transitionsBuilder: TransitionsBuilders.fadeIn),
  ],
)
class $AutoRouter {}
