...
Widget buildFoodCategory(BuildContext context, String categoryId, String selectedImgPath, String unSelectedImgPath, bool isSelected) {
...
Widget buildTextFields({BuildContext context, String label, String hint, TextEditingController controller, FocusNode focusNode, Function onchanged, bool addHelper = false}) {
  return Padding(
...
Widget buildFoodQuantity(BuildContext context, String quantityId, bool isSelected) {
  return Expanded(
    child: InkWell(
      ...
      child: Container(
        ...
        child: Center(child: Text(quantityId, style: TextStyle(fontSize: 14, color: isSelected? Colors.white: c4))),
      ),
    ),
  );
}
    ...
    child: Row(
      children: [
        Flexible(
          ...
          child: Container(
            decoration: BoxDecoration(
                border: Border(right: BorderSide(style: BorderStyle.solid, color: c7, width: 1))
            ),
            child: Center(
              child: IconButton(
                onPressed: () {
        ...
        Flexible(
          ...
          child: Container(
            ...
            child: Center(
              child: Text('${context.watch<FoodItem>().quantityValue} ${shortenedQuantityDescription(context)}'),
            ),
          )
        ),
        ...
        Flexible(
          ...
          child: Container(
            child: Center(
              child: IconButton(
                onPressed: () => context.read<FoodItem>().incrementquantityValue(),
...
Widget buildSelectStorageLocation(BuildContext context, int value) {
  return Padding(
    ...
    child: DropdownButton(
      ...
      onChanged: (value) => context.read<FoodItem>().setstorageSpace(value),
    ),
  );
}
  ...
  return Row(
    ...
    children: [
      Radio(
        ...
        onChanged: (value) => context.read<FoodItem>().setpriority(value),
        activeColor: c2,
      ),
      Text(
        'Low Priority',
...
buildAddFoodButton({Color textColor ,Color backgroundColor, String text, Function onTap}) {
  return Container(
    height: 45,
    decoration: BoxDecoration(
